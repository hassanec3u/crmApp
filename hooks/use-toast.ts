/**
 * Hook `useToast` (version shadcn/ui).
 *
 * Implémente un mini-store global de toasts (max 3 simultanés) avec un
 * système de reducer simple. Inspiré de la lib `react-hot-toast`.
 *
 * Usage :
 *   const { toast } = useToast();
 *   toast({ title: "Sauvegardé", description: "Le prospect a été créé." });
